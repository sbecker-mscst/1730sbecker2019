...
namespace sbecker17302e1
{
    public partial class LogicalOperationsForm : Form
    {
        public LogicalOperationsForm()
        {
            InitializeComponent();
        }
        ...
        private void BtnCalculate_Click(object sender, EventArgs e)
        {
            ...
            DateTime expirationDate = Convert.ToDateTime(input07baTextBox.Text);
