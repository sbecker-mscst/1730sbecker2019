...
namespace sbecker17301g1
{
    public partial class Form1 : Form
    {
        ...
        private void BtnCalculate_Click(object sender, EventArgs e)
        {
            ...
            resultdefault01TextBox.Text = Ex2gCalculations.SwitchDefault01(input1aTextBox.Text);
            ...
            // 2d) Nested if-else
            resultNested02TextBox.Text = Ex2gCalculations.NestedIfElse02(input2aTextBox.Text);
